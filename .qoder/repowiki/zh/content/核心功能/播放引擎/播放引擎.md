...
## 更新摘要
**变更内容**   
- 新增 `replayCurrentSpeech()` 方法实现即时语音切换功能，支持播放中实时切换音色
- 重构 speech 处理逻辑，提取独立的 `processSpeechAction()` 方法提高代码复用性
- 增强音频播放器语音切换能力，支持 {voice} 模板替换和 IndexedDB 语音后缀交换
- 优化播放状态管理，确保语音切换时不会丢失播放进度和状态一致性
...
**章节来源**
- [lib/playback/engine.ts:584-658](file://lib/playback/engine.ts#L584-L658)
...
**章节来源**
- [lib/playback/engine.ts:457-478](file://lib/playback/engine.ts#L457-L478)
