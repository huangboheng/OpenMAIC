...
图表来源
- [use-preview-timer.ts:1-77](file://lib/hooks/use-preview-timer.ts#L1-L77)
...
- [use-tts-preview.ts:1-93](file://lib/audio/use-tts-preview.ts#L1-L93)
...
ExpiredCheck --> |是| MarkExpired["设置 expired=true<br/>清除定时器"]
ExpiredCheck --> |否| UpdateState["更新 remainingSeconds"]
UpdateState --> SetInterval
MarkExpired --> Cleanup["组件卸载时清理定时器"]
```
