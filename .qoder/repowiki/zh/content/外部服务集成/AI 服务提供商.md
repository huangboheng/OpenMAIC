...
- [lib/types/provider.ts:8-192](file://lib/types/provider.ts#L8-L192)
- [lib/ai/providers.ts:63-1278](file://lib/ai/providers.ts#L63-L1278)
- [lib/ai/llm.ts:282-310](file://lib/ai/llm.ts#L282-L310)
...
- 模型探测与可用性
  - probe-models 仅返回聊天模型，过滤 TTS/ASR/embedding 等非聊天模型。
...
- [lib/ai/azure.ts:9-28](file://lib/ai/azure.ts#L9-L28)
- [app/api/provider/probe-models/route.ts:19-68](file://app/api/provider/probe-models/route.ts#L19-L68)
- [lib/ai/llm.ts:260-272](file://lib/ai/llm.ts#L260-L272)
- [lib/server/provider-config.ts:673-678](file://lib/server/provider-config.ts#L673-L678)
...
**章节来源**
- [lib/ai/providers.ts:63-1278](file://lib/ai/providers.ts#L63-L1278)
- [lib/ai/model-metadata.ts:242-415](file://lib/ai/model-metadata.ts#L242-L415)
- [README-zh.md:152-208](file://README-zh.md#L152-L208)
